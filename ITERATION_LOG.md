...
## 2026-01-24
- Generated new task list in TASKS.md.
## 2026-01-24
- Generated new task list in TASKS.md.
## 2026-01-24
- Generated new task list in TASKS.md (6 items).
## 2026-01-24
- Generated TASKS.md via Codex.
## 2026-01-24
- Generated TASKS.md via Codex.
## 2026-01-24
- Ran auto-exec via Codex (dry-run: true, allow-dirty: true).
## 2026-01-24
- Generated TASKS.md via Codex.
## 2026-01-24
- Generated TASKS.md via Codex.
...
- Generated TASKS.md via Codex.
## 2026-01-26
- Drawdown Recovery Scenarios UX QA (desktop + mobile) — top 5 friction points:
  1) On mobile, the hero + CTA block pushes the tool well below the fold, and there is no “jump to tool” anchor.
  2) Drawdown input is slider-only; precise values are hard to set on touch, and there is no numeric field.
  3) Recovery horizons are fixed to 1/3/5 years with no custom timeline option.
  4) “Approx monthly return” is not explicitly labeled as compounded monthly, which may be misread as simple monthly.
...
## 2026-01-30
- 真机回归（iOS Safari + Android Chrome）在当前环境中仍无法直接执行；已从 HTML/CSS/inline JS 层面逐页审查 `/en/` 和 `/zh/` 版本的 Drawdown Test/Drawdown Recovery/Rebalancing Planner 的滑杆/数值输入/tooltip/锚点跳转与触控/焦点样式，确认 EN/ZH 逻辑、`touch-action`、`focus-visible` 聚焦轮廓、tooltip 层级及 `rm_*` localStorage 交互保持一致，未发现需要即刻修复的问题；所有结论已写入 `ITERATION_LOG.md` 和 TASKS 以便后续真机验证与 QA 跟进。
## 2026-01-30
- [2026-01-30T16:18:57+08:00] Ran auto-exec via Codex (dry-run: false, allow-dirty: true).
## 2026-01-30
- [2026-01-30T16:00:00+08:00] Ran auto-run (allow-dirty: true, dry-run: false, full-auto: true, skip-commit: false, force-lock: false).
## 2026-01-30
- [2026-01-30T16:30:00+08:00] Generated TASKS.md via Codex.
## 2026-01-30
- [2026-01-30T16:32:14+08:00] Ran auto-exec via Codex (dry-run: false, allow-dirty: true).
## 2026-01-30
- [2026-01-30T16:30:00+08:00] Ran auto-run (allow-dirty: true, dry-run: false, full-auto: true, skip-commit: false, force-lock: false).
